...
function RecommendationHistory({ recommendations, onReview, correctCount, wrongCount }) {
  ...
  return <section className="rounded-xl border border-[#ececf2] bg-white p-4 shadow-sm">
